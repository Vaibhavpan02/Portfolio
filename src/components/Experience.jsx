...
const data = [
  {
    ...
    tasks: [
      ...
      'Implemented features in frontend part with 100% responsive design',
  ...
  },
  {
    ...
    fromDate: new Date('2022-08-07'),
    toDate: new Date('2022-09-07'),
    tasks: [
      'Built more than 3+ projects from landing pages to Featured web applications',
      'Worked on the frontend technologies like HTML, CSS, JavaScript, Bootstrap',
    ],
  },
];
